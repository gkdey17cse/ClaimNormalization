...
This project also includes a **Streamlit-based web interface** to interactively test the claim normalization pipeline. The app allows users to input noisy social media claims and view cleaned, normalized versions generated by either or both of the fine-tuned models: **T5-small** and **BART-base**.
...
* **Model Selection Dropdown**: Choose T5, BART, or both.
* **Real-Time Inference**: Enter a noisy claim to instantly see normalized outputs.
* **Dual Output View**: Compare outputs side-by-side when both models are selected.

---

## 🖼️ Streamlit UI Preview

![Streamlit App Interface](./Final/Result&plot/Streamlit_UI.png)
